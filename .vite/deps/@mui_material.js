...
var FormControlLabel = React33.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime41.jsxs)(FormControlLabelRoot, _extends({
    ...
    children: [React33.cloneElement(control, controlProps), required ? (0, import_jsx_runtime41.jsxs)(Stack_default, {
      display: "block",
