...
import {
  Transition_default
} from "./chunk-FFYCVNY4.js";
import {
  useTheme
} from "./chunk-PQZLG5CA.js";
import {
  require_react_dom
} from "./chunk-OTY6O57J.js";
import {
  GlobalStyles_default
} from "./chunk-GA75KOFS.js";
import {
  useRtl
...
} from "./chunk-XBJGAVMI.js";
import {
  createSvgIcon,
  init_createSvgIcon
} from "./chunk-F4CSKSEH.js";
import {
  capitalize_default,
  init_capitalize
} from "./chunk-RLGSR72Y.js";
import {
  init_useForkRef,
  useForkRef_default
} from "./chunk-VPHMCWQM.js";
import {
  init_styled,
...
var require_useThemeWithoutDefault = __commonJS({
  "node_modules/@mui/system/useThemeWithoutDefault.js"(exports) {
    ...
    var React112 = _interopRequireWildcard(require_react());
    ...
    function useTheme3(defaultTheme = null) {
      const contextTheme = React112.useContext(_styledEngine.ThemeContext);
...
function MenuProvider(props) {
  ...
  return (0, import_jsx_runtime19.jsx)(CompoundComponentContext.Provider, {
    ...
    children: (0, import_jsx_runtime19.jsx)(ListContext2.Provider, {
...
var MenuItem2 = React44.forwardRef(function MenuItem3(props, ref) {
  ...
  return (0, import_jsx_runtime23.jsx)(ListContext2.Provider, {
    value: contextValue,
...
var OutlinedInput = React82.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime58.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime58.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime57.jsxs)(React82.Fragment, {
        children: [label, " ", "*"]
      })) : label,
  ...
  return (0, import_jsx_runtime78.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime78.jsx)(InputAdornmentRoot, _extends({
      ...
      children: typeof children === "string" && !disableTypography ? (0, import_jsx_runtime78.jsx)(Typography_default, {
        ...
        children
      }) : (0, import_jsx_runtime79.jsxs)(React98.Fragment, {
        children: [position === "start" ? (
          /* notranslate needed while Google Translate will not fix zero-width space issue */
          _span8 || (_span8 = (0, import_jsx_runtime78.jsx)("span", {
            className: "notranslate",
            children: "​"
          }))
        ) : null, children]
...
var Popper3 = React99.forwardRef(function Popper4(inProps, ref) {
  var _slots$root;
  ...
  return (0, import_jsx_runtime80.jsx)(PopperRoot, _extends({
    as: component,
...
true ? Popper3.propTypes = {
   ...
   * The return value will passed as the reference object of the Popper instance.
   */
  anchorEl: import_prop_types54.default.oneOfType([HTMLElementType, import_prop_types54.default.object, import_prop_types54.default.func]),
  /**
   * Popper render function or node.
   */
  children: import_prop_types54.default.oneOfType([import_prop_types54.default.node, import_prop_types54.default.func]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default {}
   */
  popperOptions: import_prop_types54.default.shape({
    modifiers: import_prop_types54.default.array,
    onFirstUpdate: import_prop_types54.default.func,
    placement: import_prop_types54.default.oneOf(["auto-end", "auto-start", "auto", "bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]),
    strategy: import_prop_types54.default.oneOf(["absolute", "fixed"])
  }),
  /**
   * A ref that points to the used popper instance.
   */
   ...
   * @default false
   */
  transition: import_prop_types54.default.bool
} : void 0;
...
var DialogActions = React103.forwardRef(function DialogActions2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialogActions"
  });
  ...
  return (0, import_jsx_runtime83.jsx)(DialogActionsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var ListItemButton = React104.forwardRef(function ListItemButton2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemButton"
  });
  ...
  const listItemRef = React104.useRef(null);
  useEnhancedEffect_default2(() => {
    if (autoFocus) {
...
var ListItemSecondaryAction = React105.forwardRef(function ListItemSecondaryAction2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemSecondaryAction"
  });
...
var ListItem = React106.forwardRef(function ListItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItem"
  });
  const {
    ...
    slotProps = {},
    slots = {}
  } = props, ContainerProps = _objectWithoutPropertiesLoose(props.ContainerProps, _excluded56), other = _objectWithoutPropertiesLoose(props, _excluded213);
...
var Chip = React108.forwardRef(function Chip2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiChip"
  });
  ...
  const chipRef = React108.useRef(null);
  ...
  const ownerState = _extends({}, props, {
    ...
    size: size3,
    color,
    iconColor: React108.isValidElement(iconProp) ? iconProp.props.color || color : color,
    onDelete: !!onDelete,
    clickable,
    variant
  });
  ...
  let deleteIcon = null;
  if (onDelete) {
    deleteIcon = deleteIconProp && React108.isValidElement(deleteIconProp) ? React108.cloneElement(deleteIconProp, {
  ...
  let avatar = null;
  if (avatarProp && React108.isValidElement(avatarProp)) {
    avatar = React108.cloneElement(avatarProp, {
      className: clsx_default(classes.avatar, avatarProp.props.className)
    });
  }
  let icon = null;
  if (iconProp && React108.isValidElement(iconProp)) {
    icon = React108.cloneElement(iconProp, {
...
var _excluded58 = ["className", "dividers"];
...
var DialogContent = React109.forwardRef(function DialogContent2(inProps, ref) {
  ...
  return (0, import_jsx_runtime91.jsx)(DialogContentRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
true ? DialogContent.propTypes = {
   ...
   * @default false
   */
  dividers: import_prop_types61.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var _excluded59 = ["aria-describedby", "aria-labelledby", "BackdropComponent", "BackdropProps", "children", "className", "disableEscapeKeyDown", "fullScreen", "fullWidth", "maxWidth", "onBackdropClick", "onClose", "open", "PaperComponent", "PaperProps", "scroll", "TransitionComponent", "transitionDuration", "TransitionProps"];
...
var Dialog = React111.forwardRef(function Dialog2(inProps, ref) {
  ...
  return (0, import_jsx_runtime92.jsx)(DialogRoot, _extends({
    className: clsx_default(classes.root, className),
    ...
    children: (0, import_jsx_runtime92.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime92.jsx)(DialogContainer, {
        className: clsx_default(classes.container),
        onMouseDown: handleMouseDown,
        ownerState,
        children: (0, import_jsx_runtime92.jsx)(DialogPaper, _extends({
          as: PaperComponent,
          elevation: 24,
          role: "dialog",
          "aria-describedby": ariaDescribedby,
          ...
          ownerState,
          children: (0, import_jsx_runtime92.jsx)(DialogContext_default.Provider, {
...
true ? Dialog.propTypes = {
   ...
   * @default false
   */
  fullScreen: import_prop_types62.default.bool,
  /**
   ...
   * @default 'sm'
   */
  maxWidth: import_prop_types62.default.oneOfType([import_prop_types62.default.oneOf(["xs", "sm", "md", "lg", "xl", false]), import_prop_types62.default.string]),
  /**
   * Callback fired when the backdrop is clicked.
   * @deprecated Use the `onClose` prop with the `reason` argument to handle the `backdropClick` events.
   */
   ...
   * @default Paper
   */
  PaperComponent: import_prop_types62.default.elementType,
  /**
   * Props applied to the [`Paper`](/material-ui/api/paper/) element.
   * @default {}
   */
   ...
   * @default 'paper'
   */
  scroll: import_prop_types62.default.oneOf(["body", "paper"]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-T4MTDAVA.js.map
